...
class Logger(object):
    def __init__(self):
        ...
        self.log = open('logs/road/{}.txt'.format(loggername), 'w')
...
model.load_weights('weights/road/2018-11-22 13-23-50.hdf5')
...
model_checkpoint = callbacks.ModelCheckpoint('weights/road/{}.hdf5'.format(loggername), monitor = 'val_loss', verbose = 1, save_best_only = True, save_weights_only = True)
...
csv_logger = callbacks.CSVLogger('logs/road/{}.log'.format(loggername))
