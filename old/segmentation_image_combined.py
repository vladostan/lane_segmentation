...
def callback(data):
    ...
    pred = postProcess(a, b, area_threshold=7500)
    pred *= 255//2
    image_message2 = bridge.cv2_to_imgmsg(cv2.addWeighted(orig,1,cv2.applyColorMap(pred,cv2.COLORMAP_OCEAN),1,0), 'rgb8') # For visualisation in RViz
...
if __name__ == '__main__':
    ...
    pub2 = rospy.Publisher('image_publisher_postprocess', Image, queue_size=1)
