...
print('Batch size:', bs)
# In[]:
from deeplabv31p import Deeplabv31p

model = Deeplabv31p()

# In[4]:
model = SegClass.create_seg_model(net='subpixel',n=n_classes, load_weights=False, multi_gpu=False, backbone=backbone)
model.load_weights('weights/mobilenetv2_subpixel.h5')
